...
//       {/* 1. النصوص (في المنتصف) */}
//       <div className="relative z-50 text-center px-4 pointer-events-none">
//         <motion.div
...
//         {/* شيلنا الـ mt الكبيرة وخلينا الـ scale معقول عشان نضمن ظهوره */}
//         <div className="w-full h-full mt-10 scale-[1.2] md:scale-[1.4]">
//           <World data={sampleArcs} globeConfig={globeConfig} />
//         </div>
//       </div>

//       {/* 3. طبقة التظليل (اختياري - لو الكوكب ظاهر تمام ممكن تشيليها) */}
